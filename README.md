...
[![Tests](https://img.shields.io/badge/pytest-501_passing-success?logo=pytest&logoColor=white)](tests/)
...
**Native C++ handlers — not Python Remote Execution.** ~50 ms round-trips across 105 tools · 501 tests · MIT · works with Claude Code, Cursor, Cline, Codex, Gemini, Continue, Windsurf & Zed.
...
| **Bridge tests** | 501 pytest cases, ~99% coverage |
