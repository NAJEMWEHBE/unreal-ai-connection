...
[![Tests](https://img.shields.io/badge/pytest-521_passing-success?logo=pytest&logoColor=white)](tests/)
...
**Native C++ handlers — not Python Remote Execution.** ~50 ms round-trips across 106 tools · 521 tests · MIT · works with Claude Code, Cursor, Cline, Codex, Gemini, Continue, Windsurf & Zed.
...
| **Bridge tests** | 521 pytest cases, ~99% coverage |
