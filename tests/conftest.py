...
EXPECTED_CPP_HANDLER_COUNT = 103  # Wave 1 native lane (place_actors_raycast, batch_material_assign, light_raycast_placement, nanite_collision_toggle) + Wave 2 (post_process_grade_preset)
