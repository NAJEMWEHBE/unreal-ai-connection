...
EXPECTED_CPP_HANDLER_COUNT = 102  # bumped from 98 — added Wave 1 studio-builder native lane: place_actors_raycast, batch_material_assign, light_raycast_placement, nanite_collision_toggle
