...
5. **First-call test.** In Cascade: *"Call get_engine_version through unreal-claude-mcp."*
...
Cascade panel → 🔨 tools icon → expand `unreal-claude-mcp`. Tool count should match the 104 published tools.
