...
**Confirmed instances:**
- PR #51: Codex's own report said "attempted RunUAT BuildPlugin for a full compile check but the sandbox blocked writes under `C:\Users\NINOH\AppData\Local\UnrealEngine\...`"
