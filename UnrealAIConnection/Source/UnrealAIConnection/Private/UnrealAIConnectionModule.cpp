...
extern TSharedRef<IUCMCPHandler> Make_Handler_DuplicateActor();
extern TSharedRef<IUCMCPHandler> Make_Handler_SetActorFolder();
extern TSharedRef<IUCMCPHandler> Make_Handler_RenameActor();
...
extern TSharedRef<IUCMCPHandler> Make_Handler_ExportActorAsGltf();
...
void FUnrealAIConnectionModule::StartupModule()
{
    ...
    Reg.Register(Make_Handler_DuplicateActor());
    Reg.Register(Make_Handler_SetActorFolder());
    Reg.Register(Make_Handler_RenameActor());
    ...
    Reg.Register(Make_Handler_ExportActorAsGltf());
