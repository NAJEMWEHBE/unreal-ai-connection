...
//
// UnrealAIConnectionNDisplay - optional companion plugin for Unreal AI Connection.
//
// It exists purely to keep the nDisplay dependency (DisplayCluster /
// DisplayClusterConfiguration) OUT of the core plugin. The core plugin links neither,
// so UnrealEditor-UnrealAIConnection.dll loads on any project regardless of whether the
// nDisplay plugin is enabled. This companion (disabled by default) brings the
// inspect_ndisplay_config MCP tool online when, and only when, a project opts in by
// enabling it.
//
...
#include "UnrealAIConnectionNDisplayModule.h"

#include "Modules/ModuleManager.h"
#include "MCP/MCPHandler.h"

// Handler factory, defined in this module's Handler_*.cpp.
extern TSharedRef<IUCMCPHandler> Make_Handler_InspectNdisplayConfig();

void FUnrealAIConnectionNDisplayModule::StartupModule()
{
    ...
    RegisterHandler(Make_Handler_InspectNdisplayConfig());
}

void FUnrealAIConnectionNDisplayModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FUnrealAIConnectionNDisplayModule, UnrealAIConnectionNDisplay)
