...
//
// UnrealAIConnectionOCIO - optional companion plugin for Unreal AI Connection.
//
// It exists purely to keep the OCIO dependency (OpenColorIO / OpenColorIOWrapper) OUT
// of the core plugin. The core plugin links neither, so UnrealEditor-UnrealAIConnection.dll
// loads on any project regardless of whether the OpenColorIO plugin is enabled. This
// companion (disabled by default) brings the inspect_ocio_config MCP tool online when,
// and only when, a project opts in by enabling it.
//
...
#include "UnrealAIConnectionOCIOModule.h"

#include "Modules/ModuleManager.h"
#include "MCP/MCPHandler.h"

// Handler factory, defined in this module's Handler_*.cpp.
extern TSharedRef<IUCMCPHandler> Make_Handler_InspectOcioConfig();

void FUnrealAIConnectionOCIOModule::StartupModule()
{
    ...
    RegisterHandler(Make_Handler_InspectOcioConfig());
}

void FUnrealAIConnectionOCIOModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FUnrealAIConnectionOCIOModule, UnrealAIConnectionOCIO)
